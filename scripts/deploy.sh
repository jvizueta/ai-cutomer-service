...
echo "Deploying Lyra to Kubernetes..."
...
kubectl rollout status deployment/lyra -n "$NAMESPACE" --timeout=300s
...
echo "  # Lyra AI Agent:"
echo "  kubectl port-forward -n $NAMESPACE svc/lyra 8000:8000"
...
echo "  NAMESPACE=lyra-dev ./scripts/deploy.sh"
echo ""
